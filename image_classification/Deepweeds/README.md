...
**[IMPORTANT]** You can download the necessary data to run this program from [The official DeepWeeds dataset repository](https://github.com/AlexOlsen/DeepWeeds) and link it appropriately in the `config.yaml` provided.
